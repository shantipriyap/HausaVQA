...
def main(args):
    ...
    np.savetxt('/home/jupyter/HausaVQA/IC/lstm/expt/log/train_loss_epoch.txt', np.array(train_loss), delimiter=',')
    np.savetxt('/home/jupyter/HausaVQA/IC/lst/mexpt/log/val_loss_epoch.txt', np.array(val_loss), delimiter=',')
